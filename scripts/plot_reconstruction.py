...
images_to_plot = [
    ...
    dirty_facet[inds],
    decon_blend[inds],
    # residuals can be recomputed here if needed
    recon_blend[inds],
]
...
# %%
mask = (blendedness_vals > 0.2) & (flux > 40 * 1e-6)
...
subs = [flux_labels, blendedness_labels, metrics1, metrics_2]
